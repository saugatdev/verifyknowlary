...
export default function App() {
    ...
    const initializeFromUrl = () => {
      try {
        ...
        if (path.startsWith('/certificate/')) {
          idFromUrl = path.split('/certificate/')[1];
  ...
  const handleShare = (platform: 'linkedin' | 'x' | 'whatsapp' | 'email') => {
    ...
    const text = encodeURIComponent(`I am proud to share that I've completed the ${certificate.courseName} program at Knowlary! View my verified credential here:`);
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex flex-col font-sans selection:bg-brand selection:text-white overflow-x-hidden text-slate-900">
                  ...
                  <div className="bg-white rounded-3xl border border-slate-200 shadow-[0_20px_60px_rgba(0,0,0,0.06)] p-6 text-left">
                    ...
                    <div className="space-y-4 text-sm text-slate-600">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-slate-900 text-right ml-4">{certificate?.courseName}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono text-xs text-slate-900">{certificate?.verificationCode}</span>
                      </div>
                    </div>
                  </div>

                  <div className="bg-white rounded-3xl border border-slate-200 shadow-[0_20px_60px_rgba(0,0,0,0.06)] p-5 space-y-3">
                    <button
